...
class MapAxis(CoordinateTransformation):
    ...
    type: Optional[TransformationType] = Field(
        default="map_axis", description="""The type of transformation."""
    )
    name: Optional[str] = Field(
        default=None, description="""The name of the coordinate transformation"""
    )
...
class Scale(CoordinateTransformation):
    ...
    scale: Optional[list[float]] = Field(
        default=None, description="""The scaling vector"""
    )
    type: Optional[TransformationType] = Field(
...
class MovieStackSeries(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""The name of the series.""")
...
class TiltSeries(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="""The name of the tilt series."""
    )
...
class PointSet2D(Annotation, CoordMetaMixin):
    ...
    ] = Field(default=None, description="""Location on a 2D image (Nx2).""")
    coordinate_systems: Optional[list[CoordinateSystem]] = Field(
        default=None, description="""Named coordinate systems for this entity"""
    )
    coordinate_transformations: Optional[list[CoordinateTransformation]] = Field(
...
class Region(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""Name of the region.""")
